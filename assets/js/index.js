function parser(inputString) {
    switch (inputString.trim()) {
        ...
        case "help":
            ...
            var content = document.createTextNode("offline@id.beta.v-1.app:~ " + inputString);
        ...
        case "managingdirector":
           var img = new Image();
img.src = 'https://offline.identifier.info/wp-content/uploads/2023/06/Endorsee-HGKL.png';
img.onclick = function() {
    window.location.href = 'https://offline.identifier.info/wp-content/uploads/2023/06/Endorsee-HGKL.png';
};
